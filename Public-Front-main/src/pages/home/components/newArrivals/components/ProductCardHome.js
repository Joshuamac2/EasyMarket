...
function ProductCardHome(props) {
  ...
  const isOnSale = product.pricingOptions.some(
    (option) => option.sale !== null
  );
    ...
    <div>
      <div style={{ position: "relative" }}>
        ...
        <div style={{ textAlign: "left", fontFamily: "Sans-serif" }}>
          <div
            style={{ fontSize: "20px", color: "#7D775D", fontWeight: "bolder" }}
          ...
          <div
            style={{ fontSize: "18px", color: "#F9C1A0", fontWeight: "bolder" }}
          >
